...
Sebuah aplikasi web sederhana untuk membantu mahasiswa membuat pesan chat yang sopan dan terstruktur untuk dikirimkan kepada dosen. Aplikasi ini dibuat menggunakan **PHP** dan **JavaScript**.
...
1.  **Clone repository ini:**
    ```bash
    git clone [https://github.com/idrmdhni/chatdosengenerator.git](https://github.com/idrmdhni/chatdosengenerator.git)
    ```
